...
//  "Mars  3390   641.85    " 
character(len=*), parameter :: SIMPLE_LIST_WITH_ROW_HEADERS = &
    "Sun   696000 1.9891e+09" // NEWLINE &
//  "Earth   6371     5973.6" // NEWLINE &
//  "Moon    1737       73.5" // NEWLINE &
//  "Mars    3390     641.85" 
contains
  ...
  function check_row_headers() result(result_)
    ...
    tabular_string = tabulate(simple_list, row_headers=.true.)


    result_ = assert_equals(SIMPLE_LIST_WITH_ROW_HEADERS, tabular_string)
  end function
end module